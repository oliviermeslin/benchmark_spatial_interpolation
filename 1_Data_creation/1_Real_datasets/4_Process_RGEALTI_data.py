...
for file in files:
    ...
    # Download the data
    print("    Download data")
    os.system(f"mc cp s3/{file} RGEALTI.tif")

    # Open the TIFF file
    print("    Open the TIFF file")
    dataset = gdal.Open('RGEALTI.tif', gdal.GA_ReadOnly)
