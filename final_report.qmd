...
\rule{\linewidth}{0.4mm}\\[0.3cm]
\large{\textsc{\href{https://github.com/oliviermeslin/benchmark_spatial_interpolation.git}{GitHub Repository}}}
...
There will be plenty datasets to cover combinations of, **Real or Synthetic**, **Large or Small** and **Grid or No Grid**. It will also be about, very large, extremly large datasets and noisy datasets. 
...
| --- | --- | --- | --- | --- | --- |
| **bdalti** | Real | Large | No Grid | Smooth | ~7,000,000 |
| **bdalti_48** | Real | Small | No Grid | Smooth | ~40,000 |
| **rgealti** | Real | Large | Grid | Smooth | ~22,000,000,000 |
| **rgealti_48** | Real | Small | Grid | Smooth | ~1,500,000 |
| **S-G-Sm** | Synthetic | Small | Grid | Smooth | 5,000 |
| **S-G-Lg** | Synthetic | Large | Grid | Smooth | 100,000 |
| **S-NG-Sm** | Synthetic | Small | No Grid | Smooth | 5,000 |
| **S-NG-Lg** | Synthetic | Large | No Grid | Smooth | 100,000 |
| **S-NG-VLg** | Synthetic | Very Large | No Grid | Smooth | 1,000,000 |
| **S-NG-ELg** | Synthetic | Extremely Large | No Grid | Smooth | 10,000,000 |
...
| **cal_housing** | Real | Medium | No Grid | Noisy | ~20,000 |
...
Ultimately, while CR introduces a slight computational overhead, the training time remains in the order of seconds orders of magnitude faster than Geostatistical approaches. This establishes Ensemble Learning with Coordinate Rotation as a reccomended strategy for large, structured spatial datasets, while in case noise dominates the signal or when spatial coordinates provide weak predictive information simpler methods may suffice.
