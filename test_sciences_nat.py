...
df2 = (
    ...
    .select("latitude", "longitude", "hours_since_ref", "temperature_celsius")
)
...
baseline_preprocessor.fit(
    ...
    train.select("temperature_celsius")
)
...
# %%
eval_set = [
    (train_trans, train["temperature_celsius"].to_numpy().ravel()),
    (val_trans, val["temperature_celsius"].to_numpy().ravel())
]
eval_names = ["Train", "Validation"]
baseline_model[-1].fit(
    train_trans,
    train["temperature_celsius"].to_numpy().ravel(),
    eval_set=eval_set,
