...
from migbt import SklearnMIXGBooster
...
MODELS = [
    ...
    {
        "name": "mixgboost_smart",
        "class": SklearnMIXGBooster,
        "params": {
            # --- Parametri Ricalibrati ---
            "learning_rate": 0.05,  # Alziamo la velocità (era 0.005)
            "lamb": 0.1,            # Manteniamo un peso spaziale prudente
            "k": 30,                # Vicini standard
            
            # --- Parametri XGBoost ---
            "n_estimators": 300,    # Numero standard di alberi
            "max_depth": 10,        # Profondità per catturare i dettagli
            "n_jobs": -1,
            
            # Togliamo i vincoli eccessivi che rallentavano troppo
            "min_child_weight": 1, 
        },
    },
